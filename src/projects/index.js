...
const PROJECTS = [
  {
    name: 'React Apollo Feature Flag',
    description:
      'Suggested implementation for Feature Flag Componentes consuming a GraphQL API using Apollo Client.',
    website: 'https://github.com/peaonunes/react-apollo-feature-flag',
    repository: 'https://github.com/peaonunes/react-apollo-feature-flag',
    img: 'https://miro.medium.com/max/4896/0*UjQvxWY9Nq2ysewq',
    date: '2018',
    skills: ['Apollo GraphQL', 'GraphQL', 'React']
  },
  {
    name: 'Customizable Parallel Sets',
    description:
      'Open source plug and play Dashboard to load .csv and .json files and visualize the data using Parallel Sets.',
  ...
  },
  {
    name: 'CInQuest',
    description:
      'PET-Informática project, RPG Game based on Unity to help freshers deal with their firsts challenges at CS department.',
  ...
  },
  {
    ...
    description:
      "Data Visualization final project about Recife's Education, exploring open data to visualize schools facilities and performance.",
  ...
  },
  {
    name: 'Color Matches',
    description:
      'Swift game to answer if the color matches the previous color shown.',
  ...
  },
  {
    ...
    description:
      'Neural Networks final project. Focusing on achieve its best performance applied to a breast cancer detection database.',
  ...
  },
  {
    ...
    description:
      'Research of Software Inspection under a Theoretical look, Enterprise usage and Software Quality.',
  ...
  },
  {
    ...
    description:
      'A Data Mining Approach for Evaluating the Solution of Costumer Complaints, final Decision and Data Mining Support Systems project.',
  ...
  },
  {
    name: 'Stig Startup',
    description:
      'Led project management and developing Client/Server iOS Application, running Lean Startup methodology.',
    img:
      'https://scontent.frec3-2.fna.fbcdn.net/v/t1.0-1/p200x200/1234371_202650289913726_2141085768_n.png?oh=5ccf850b6b37a54ea3016b201c8abcf8&oe=5A8E3DDD',
    date: '2014-2015',
...
class Projects extends React.Component {
            ...
            return (
              <div
                ...
                <div className="col s12 center hide-on-med-and-up project-content">
                  <Content project={project} onClick={this.trackClick} />
  ...
  trackClick = (event, link, name) => {
    this.context.mixpanel.track('project_link_clicked', {
      link: link,
      name: name
    })
  }
