    ...
    return (
      <div className="row">
        ...
        <div className="education-row">
          ...
          <div className="col s12 m6 l6">{this.renderOthers()}</div>
        </div>
      </div>
    );
  }
            ...
            >
              <div className="row">
                <div className="col l2 m2 left hide-on-small-only show-on-medium-and-up">
                  <img
                    src={university.img}
                    className="circle education-img"
                    alt={university.name}
                  />
                </div>
    ...
    return (
      <div className="col s12 m12 l12 list-row" data-aos="fade-up">
        <b>
          <span>
            <i
              className="fa fa-search education-icon education-link-wrapper"
              aria-hidden="true"
            />
            Articles
          </span>
        ...
        {ARTICLES.map((article, index) => {
          return (
            <ul key={`${article}_${index}`}>
              ...
              <li>
                @ {article.conference}
                {this.renderEducationLink(
                  article.conference_href,
                  "Website",
                  "fa fa-link"
                )}
                {this.renderEducationLink(
      ...
      return (
        <span className="education-link-wrapper">
          <a
            ...
            target="_blank"
            onClick={e => this.trackClick(e, link, name)}
          >
    ...
    return (
      <div className="col s12 m12 l12" data-aos="fade-up">
        <span>
          <b>
            <i
              className="fa fa-certificate education-icon education-link-wrapper"
              aria-hidden="true"
            />
            Certifications
          </b>
